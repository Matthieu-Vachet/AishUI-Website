...
function GridFeature() {
    return (
        <div className="mx-auto h-[28rem] overflow-hidden md:h-auto md:overflow-auto z-50 lg:max-w-[80vw]">
            <div className="flex snap-x snap-mandatory gap-6 overflow-x-auto px-8 pb-12 md:flex-wrap md:overflow-hidden">
                <div className="relative flex min-h-[20rem] w-full shrink-0 snap-center flex-col items-center justify-center md:justify-end overflow-hidden rounded-[3rem] border border-transparent-white bg-glass-gradient p-8 text-center md:max-w-[calc(66.66%-12px)] md:basis-[calc(66.66%-12px)] md:p-4">
                    <VelocityScroll
                        ...
                        default_velocity={1}
                        className=" font-Morpheus text-center text-5xl font-semibold tracking-[-0.02em] drop-shadow-sm text-white opacity-30 hover:opacity-100 transition-opacity duration-300 ease-in-out  lg:text-6xl leading-[5rem] lg:leading-[8rem]"
                    />
                ...
                <div className="relative flex min-h-[20rem] w-full shrink-0 snap-center flex-col items-center justify-center overflow-hidden rounded-[3rem] border border-transparent-white bg-glass-gradient p-20 text-center md:basis-[calc(33.33%-12px)] md:p-4 gap-16">
                ...
                <div className="group relative flex min-h-[20rem] w-full shrink-0 snap-center flex-col items-center justify-center overflow-hidden rounded-[3rem] border border-transparent-white bg-glass-gradient p-8 text-center md:basis-[calc(33.33%-12px)] md:p-4 gap-10">
                ...
                <div className="relative flex justify-center min-h-[20rem] w-full shrink-0 snap-center flex-col items-center overflow-hidden rounded-[3rem] border border-transparent-white p-8 text-center md:max-w-[calc(66.66%-12px)] md:basis-[calc(66.66%-12px)] md:p-4">
                    ...
                    <div className="flex flex-col relative z-10 gap-10">
                        ...
                        <p className="mb-4 text-2xl lg:text-3xl text-white/50 font-semibold">
                            Spécialement conçu pour améliorer l&apos;expérience visuel.
                        </p>
                    </div>
                </div>
            </div>
