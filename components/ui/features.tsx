    ...
    return (
        <div
            ...
            className={classNames(
                ...
                inView && "is-visible before:opacity-50 before:[transform:rotate(180deg)_scale(2)]",
...
const MainFeature = ({ text, title, title2 }: MainFeatureProps) => {
    return (
        <>
            <div className="relative before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_50%_50%_at_center,rgba(var(--feature-color),0.01),transparent)]">
                <Container className={classNames("max-w-[95%] text-center")}>
                    <h1 className="text-gradient mb-11 translate-y-[40%] pt-[12rem] text-center text-5xl [transition:transform_1000ms_cubic-bezier(0.3,_1.17,_0.55,_0.99)_0s] md:pt-0 md:text-7xl lg:text-8xl [.is-visible_&]:translate-y-0">
                        {title}
                        <span className="text-gold-100">{title2}</span>
                    </h1>
                </Container>
            </div>
