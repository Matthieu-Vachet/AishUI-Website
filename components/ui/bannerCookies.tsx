...
const CookieConsent = (props: any) => {
    ...
    return (
        <div className="fixed inset-0 z-50 h-5 flex items-center justify-center">
            <div className="fixed bottom-5 md:left-5 w-[90%] md:w-[30%] 3xl:w-[20%] flex flex-col md:flex-row md:justify-around text-center mx-auto py-4 gap-5 bg-black-100/50 p-5 rounded-xl border border-gold-100">
                ...
                <div className="flex flex-col gap-5 justify-center">
                    <button
                        className="bg-gold-100 py-2 px-8 rounded text-white border border-white hover:bg-brown-100 transition-all duration-300 ease-in-out"
